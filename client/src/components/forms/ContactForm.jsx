...
export function ContactForm() {
  ...
  const submit = async (data) => {
    ...
    try {
      ...
      setServerSuccess(
        'Your message has been submitted successfully. Our team has received your information and will contact you shortly.'
      )
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit(submit)} noValidate>
      ...
      {serverSuccess && (
        <Alert variant="success" title="Message Submitted Successfully">
          {serverSuccess}
        </Alert>
      )}
